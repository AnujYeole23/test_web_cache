...
abstract class OpfsHelper {
  static Future<FileSystemDirectoryHandle?> getDirectoryHandle({String? directoryName}) async {
  ...
  static Future<FileSystemFileHandle?> getFileHandle(String localPath) async {
    ...
    final directoryHandle = await getDirectoryHandle(directoryName: directoryName);
    if (directoryHandle == null) {
      return null;
    }
